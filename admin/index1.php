    ...
    <body id="page-top">
        ...
        <div id="wrapper">
            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <!-- Sidebar - Brand -->
               <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index1.php?page=Home">
                    <img class="img-profile rounded-circle" src="../assets/images/dinas.png" width="80" height="50">
                    <div class="sidebar-brand-text mx-2">Data BBM </div>
                </a>
