          ...
          <div class="form-group">
            <div class="form-group" align="center">
              ...
              <div class="previewWrapper">
                <img class='img-responsive img-rounded' width='150' height='150' src='../assets/images/data_bon/<?= $data['foto_bon']; ?>' id="output_image" />
                <div id="previews">
                </div>
              </div>
              <div class="uploadBtn">
                <span class="btn btn-primary btn-xs">
                  ...
                  <span>
                   Ukuran Max file : 1 MB
                    <input type="text" name="foto_bon" value="<?= $data["foto_bon"] ?>">
