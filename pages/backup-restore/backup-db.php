				...
				<div class="box-body">
					<div class="panel-body">
						<?php
							...
							backup_tables("localhost","root","","seminar",$file);
						?>
						<p align="center">Backup database telah berhasil !</p><br />
						<p align="center"><a style="cursor:pointer" class="btn btn-info" onclick="location.href=
						'../pages/backup-restore/download_backup_data.php?nama_file=<?php echo $file;?>'" title="Download">Download file database</a>
						</p>
							<?php
						/*
