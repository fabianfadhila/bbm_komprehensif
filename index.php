...
<head>
  ...
  <title>Login Pengelolaan Data BBM</title>
  ...
  <div class="container">
    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-10 col-lg-12 col-md-9">
        ...
        <br>
          <img class="img-profile rounded-square"  src="assets/images/logo-dinas.png" width="450" height="300">
        </div>
              <div class="col-lg-7">
                <div class="p-5">
                  <div class="text-center">

                    <h1 class="h4 text-gray-900 mb-4">Selamat Datang di Perangkat Lunak</h1>
                    <h1 class="h4 text-gray-900 mb-4">Pengelolaan Data Pembelian BBM</h1>
                      
                  </div>
                  <form action="controlers/login/cek-login.php" method="post">
